  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-100 bg-white/95 backdrop-blur">
      <div className="relative mx-auto flex max-w-6xl items-center justify-between gap-3 px-6 py-3">
        <Link href="/" className="flex items-center" aria-label="Sandro Higuti — início">
          <Image
            src="/logo-sandro.png"
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-brand-pink px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-pink-600"
          >
