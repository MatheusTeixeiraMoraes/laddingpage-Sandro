  ...
  return (
    <div className="flex items-center gap-5 rounded-2xl border border-brand-pink/30 bg-brand-navy px-6 py-6 sm:px-8">
      ...
      <p className="text-sm leading-relaxed text-slate-300">
        Os valores e condições comerciais apresentados neste site são meramente
        informativos e referem-se às unidades disponíveis no momento da
        atualização. Os preços, disponibilidade e condições de pagamento podem
        ser alterados pela construtora sem aviso prévio. Consulte sempre as
        condições vigentes no momento da negociação.
      </p>
    </div>
  );
}
